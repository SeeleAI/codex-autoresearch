...
class CheckSkillInvariantsTest(unittest.TestCase):
    ...
    def test_exec_invariants_accept_bundled_helper_usage_in_event_log(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                "\n".join(
                    [
                        'command: python3 .agents/skills/codex-autoresearch/autoresearch/scripts/autoresearch_init_run.py --mode exec',
                        'command: python3 .agents/skills/codex-autoresearch/autoresearch/scripts/autoresearch_record_iteration.py --status keep',
                        'command: python3 .agents/skills/codex-autoresearch/autoresearch/scripts/autoresearch_exec_state.py --cleanup',
                    ]
                )
                + "\n",
                encoding="utf-8",
    ...
    def test_exec_invariants_accept_admin_scope_skill_paths(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                "\n".join(
                    [
                        "command: python3 /etc/codex/skills/codex-autoresearch/autoresearch/scripts/autoresearch_init_run.py --mode exec",
                        "command: python3 /etc/codex/skills/codex-autoresearch/autoresearch/scripts/autoresearch_record_iteration.py --status keep",
                        "command: python3 /etc/codex/skills/codex-autoresearch/autoresearch/scripts/autoresearch_exec_state.py --cleanup",
                    ]
                )
                + "\n",
                encoding="utf-8",
    ...
    def test_exec_invariants_accept_user_scope_skill_paths(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                "\n".join(
                    [
                        "command: python3 /Users/alice/.agents/skills/codex-autoresearch/autoresearch/scripts/autoresearch_init_run.py --mode exec",
                        "command: python3 /Users/alice/.agents/skills/codex-autoresearch/autoresearch/scripts/autoresearch_record_iteration.py --status keep",
                        "command: python3 /Users/alice/.agents/skills/codex-autoresearch/autoresearch/scripts/autoresearch_exec_state.py --cleanup",
                    ]
                )
                + "\n",
                encoding="utf-8",
    ...
    def test_exec_invariants_accept_absolute_configured_skill_paths(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                "\n".join(
                    [
                        "command: python3 /opt/skills/codex-autoresearch/autoresearch/scripts/autoresearch_init_run.py --mode exec",
                        "command: python3 /opt/skills/codex-autoresearch/autoresearch/scripts/autoresearch_record_iteration.py --status keep",
                        "command: python3 /opt/skills/codex-autoresearch/autoresearch/scripts/autoresearch_exec_state.py --cleanup",
                    ]
                )
                + "\n",
                encoding="utf-8",
    ...
    def test_exec_invariants_reject_legacy_root_level_helper_paths(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            repo = Path(tmp)
            event_log = repo / "events.jsonl"
            self.write_exec_repo(repo)
