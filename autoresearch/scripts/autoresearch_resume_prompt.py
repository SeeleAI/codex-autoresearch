...
from autoresearch_project_docs import STATE_DIR_NAME
    ...
    lines.extend(
        [
            ...
            *[f"- {item}" for item in RUNTIME_CHECKLIST],
            ...
            "- Read AGENTS.md and the project index before executing changes.",
            ...
            "- Keep project documents synchronized with runtime artifacts whenever material state changes occur.",
